...
public class Day06 : Day
{
    ...
    private static HashSet<(int x, int y, Direction)> GetAllGuardPositions((int x, int y) position, Direction direction, Grid grid)
    {
    ...
    private static ((int x, int y) newPosition, Direction newDirection) MoveGuard((int x, int y) position, Direction direction, Grid grid)
    {
        switch (direction)
        {
            case Direction.Up:
